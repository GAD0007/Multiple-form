...
document
  ...
  .classList.remove("hidden-Display-step1");
document
  .querySelector(".adds-on-price-year")
  .classList.add("year-price-hidden");
document
  .querySelector(".adds-on-price-month")
  .classList.remove("month-price-hidden");
document
  .querySelector(".adds-on-price-year1")
  .classList.add("year-price-hidden1");
document
  .querySelector(".adds-on-price-month1")
  .classList.remove("month-price-hidden1");
document
  .querySelector(".adds-on-price-year2")
  .classList.add("year-price-hidden2");
document
  .querySelector(".adds-on-price-month2")
  .classList.remove("month-price-hidden2");
document.querySelector(".empty-check-box").style.backgroundColor =
  "transparent";
document.querySelector(".empty-check-box1").style.backgroundColor =
  "transparent";
document.querySelector(".empty-check-box2").style.backgroundColor =
  "transparent";
...
const onlineServiceChoiceDisplay = document.querySelector(
  ".display-adds-ons-online"
);
const largerServiceChoiceDisplay = document.querySelector(
  ".display-adds-ons-larger"
);
const customizableServiceChoiceDisplay = document.querySelector(
  ".display-adds-ons-customize"
);
...
const priceTagCustomizeService = document.querySelector(
  ".adds-on-price-month2"
);
...
const confirmBtnSmall = document.getElementById("btn--7-small");
...
const DisplayAddsCustomize = document.querySelector(
  ".display-customize-details"
);
...
const sumCalc = function (params) {
  ...
  const totalValueFinally =
    subValue +
    onlineServiceValue +
    customizableServiceValue +
    largerServiceValue;
...
// switch to step 2
previousStep2Small.addEventListener("click", backToPage2);
...
previousStep3Small.addEventListener("click", backtopage3);
previousStep3.addEventListener("click", backtopage3);

// next btn to summary page
nextBtnStep3Small.addEventListener("click", sumCalc);
nextBtnStep3.addEventListener("click", sumCalc);


// change sub from confirmation page
changeBtnStep4.addEventListener("click", changeSubBtn);

// confirm button
confirmBtnSmall.addEventListener("click", confirmFunction);
